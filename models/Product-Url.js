...
const productUrlSchema = new mongoose.Schema({
    producu_id: { type: String, required: true, ref: "Product" }, // Reference to the Product model
    filesUrl: [{ type: String, required: true }], // Array of image URLs
    date: { type: Date, default: Date.now }, // Date of upload
});

const ProductUrl = mongoose.models.ProductUrl || mongoose.model("product_url", productUrlSchema);
