...
const HomeProducts = () => {
  ...
  return (
    <div className="flex flex-col items-center pt-14">
      ...
      {
        products.length === 0 ? <div className="h-[400px]"><Loading /></div> :
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 flex-col items-center gap-6 mt-6 pb-14 w-full h-[600px] overflow-x-hidden overflow-y-auto">
